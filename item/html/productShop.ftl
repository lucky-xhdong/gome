...
<link rel="stylesheet" type="text/css" href="pop/css/dianzhao.min.css">
<link rel="stylesheet" type="text/css" href="pop/css/mainnav.min.css">
<link rel="stylesheet" type="text/css" href="${page.merchantInfo.cssUrl!'pop/css/color.min.css'}">
...
<body>
 ...
 <!--# include virtual="/n/common/pool/${page.merchantInfo.merchantId}.html"-->
