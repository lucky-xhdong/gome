//Windows IE32
var PGEdit_IE32_CLASSID="6028F6C6-6923-42D8-83C2-509088464276";
var PGEdit_IE32_CAB="";
var PGEdit_IE32_EXE="Gomepay.exe";
var PGEdit_IE32_VERSION="1.0.0.9";
//Windows IE64
var PGEdit_IE64_CLASSID="6028F6C6-6923-42D8-83C2-509088464276";
var PGEdit_IE64_CAB="";
var PGEdit_IE64_EXE="GomepayX64.exe";
var PGEditt_IE64_VERSION="1.0.0.9";
//Windows 非IE
var PGEdit_FF="GomepayFF.exe";
var PGEdit_FF_VERSION="1.0.0.4";
//Win10Edge / Chrome42+
var PGEdit_Edge="GomepayEdge.exe";
var PGEdit_Edge_Mac="GomepayEdgeMac.pkg";
var PGEdit_Edge_VERSION="1.0.0.2";
//Mac OS
var PGEdit_MacOs="Gomepay.pkg";
	...
	jQuery.extend(jQuery.pge, {
		...
		prototype: {
			...
			getVersion : function() {
				try {
					if (this.osBrowser==1 || this.osBrowser==3) {
						var comActiveX = new ActiveXObject("Gomepay.PassGuard.1"); 
						return comActiveX.output35;
					}else if(this.osBrowser == 2 || this.osBrowser == 6 || this.osBrowser == 8 ){
						var arr = new Array(),pge_version;
						if(this.osBrowser==2){
							var pge_info=navigator.plugins['Gomepay Control'].description;
						}else if(this.osBrowser==6 || this.osBrowser==8){
							var pge_info=navigator.plugins['Gomepay'].description;
						}
			...
			getpgeHtml: function() {
				if (this.osBrowser==1 || this.osBrowser==3) {
					...
					var pgeOcx='<embed onmouseover="'+ff+'" onfocus="'+this.settings.pgeOnfocus+'" onblur="'+this.settings.pgeOnblur+'" ID="' + this.settings.pgeId + '"  maxlength="'+this.settings.pgeMaxlength+'" input_2="'+this.settings.pgeEreg1+'" input_3="'+this.settings.pgeEreg2+'" edittype="'+this.settings.pgeEdittype+'" type="application/gomepay-x" tabindex="'+this.settings.pgeTabindex+'" class="' + this.settings.pgeClass + '" ';
					...
					return '<div id="'+this.settings.pgeId+'_down" class="'+this.settings.pgeInstallClass+'" style="text-align:center;line-height:25px;"><a href="'+this.settings.pgePath+this.pgeditFFExe+'" download="'+this.pgeditFFExe+'">'+this.pgeDownText+'</a></div>';
				} else {
			...
			getDownHtml : function() {
				if (this.osBrowser==1 || this.osBrowser==3) {
					return '<div id="'+this.settings.pgeId+'_down" class="'+this.settings.pgeInstallClass+'" style="text-align:center;line-height:28px;"><a href="'+this.settings.pgePath+this.pgeditIEExe+'" download="'+this.pgeditIEExe+'">'+this.pgeDownText+'  </a></div>';
