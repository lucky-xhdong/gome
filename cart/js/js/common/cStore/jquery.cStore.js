    ...
    var _m = (function () {
        ...
        return {
            ...
            initLoadDataByAsync: function (next) {
                ...
                //如果区数据未被选中，则不发送请求
                if (util._valuesLength(oThis.settings.value) >= 2) {
            ...
            , loadDataThreeByAsync: function (next) {
                ...
                //TODO 接口需要cookie 所以先关闭
                 util.ajaxGet.apply(this,[URL.loadDataThreeByAsync,{},function(data){
                     next.call(this, _f.parseData(data.data, structure));
                 }]);
            ...
            , loadDataEndByAsync: function (no, next) {
                ...
                util.ajaxGet(URL.loadDataEndByAsync,data,function(json){
                    next.call(this, _f.parseDateSpe(json.data, structure));
                });
               /* next.call(this, _f.parseDateSpe(cStore_config.stores, structure));*/
            }
            , dealDataCheckedStatusToSettings: function () {
        ...
        var _f = {
            ...
            , renderBoxsByCheckedStatus: function () {
                ...
                function ftl(d, type) {
                    ...
                    return ' <span data-no="' + d.no + '"><a href="javascript:;" title="' + d.name + '" data-no="'
                ...
                function renderBoxs(type) {
                    ...
                    if (!datas) {
                        util.showDebug.call(this,'function renderBoxsByCheckedStatus中数据为空');
                        var datas = this.settings[type + 's'];
                        if(type == "store"){
                            $boxs.find('[area-box-' + type + ']').html('你选择的地区未提供门店服务');
                        }
                        return;
                    }
    ...
    var _c = (function () {
        var _f = {
            ...
            , selectorBoxItems: function (e) {
                ...
                if(type ==='store'){
                    s.value[3] = no;
                    _m.dealDataCheckedStatusToSettings.call(this);
                    this.settings.callback(s.checkedStatusData);
                    _v.hide.call(this);
                    return;
                }
